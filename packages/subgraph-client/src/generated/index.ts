...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://api.studio.thegraph.com/query/65230/axisfi-auctions/0.0.18", {
    method: "POST",
...
export type AuctionLotFragmentFragment = { auctionRef: string, capacity: string, capacityInitial: string, capacityInQuote: boolean, chain: string, conclusion: string, createdBlockNumber: string, createdBlockTimestamp: string, createdTransactionHash: string, curator: string, curatorApproved: boolean, derivativeRef: string, id: string, lastUpdatedBlockNumber: string, lastUpdatedBlockTimestamp: string, lastUpdatedTransactionHash: string, lotId: string, maxBidId: string, owner: string, purchased: string, sold: string, start: string, wrapDerivative: boolean, baseToken: { address: string, decimals: string, symbol: string, name: string }, quoteToken: { address: string, decimals: string, name: string, symbol: string }, created: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, infoHash: string }, bids: Array<{ id: string }>, bidsDecrypted: Array<{ id: string }>, refundedBids: Array<{ id: string }>, settle?: { id: string } | null };

export type GetAuctionLotsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAuctionLotsQuery = { auctionLots: Array<{ auctionRef: string, capacity: string, capacityInitial: string, capacityInQuote: boolean, chain: string, conclusion: string, createdBlockNumber: string, createdBlockTimestamp: string, createdTransactionHash: string, curator: string, curatorApproved: boolean, derivativeRef: string, id: string, lastUpdatedBlockNumber: string, lastUpdatedBlockTimestamp: string, lastUpdatedTransactionHash: string, lotId: string, maxBidId: string, owner: string, purchased: string, sold: string, start: string, wrapDerivative: boolean, baseToken: { address: string, decimals: string, symbol: string, name: string }, quoteToken: { address: string, decimals: string, name: string, symbol: string }, created: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, infoHash: string }, bids: Array<{ id: string }>, bidsDecrypted: Array<{ id: string }>, refundedBids: Array<{ id: string }>, settle?: { id: string } | null }> };
...
export type GetAuctionLotQuery = { auctionLots: Array<{ auctionRef: string, capacity: string, capacityInitial: string, capacityInQuote: boolean, chain: string, conclusion: string, createdBlockNumber: string, createdBlockTimestamp: string, createdTransactionHash: string, curator: string, curatorApproved: boolean, derivativeRef: string, id: string, lastUpdatedBlockNumber: string, lastUpdatedBlockTimestamp: string, lastUpdatedTransactionHash: string, lotId: string, maxBidId: string, owner: string, purchased: string, sold: string, start: string, wrapDerivative: boolean, cancelled?: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string } | null, bids: Array<{ amountIn: string, amountOut?: string | null, bidder: string, bidId: string, blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, status: string }>, refundedBids: Array<{ blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, bid: { bidId: string, bidder: string, amountIn: string } }>, bidsDecrypted: Array<{ amountIn: string, amountOut: string, blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, bid: { bidId: string, bidder: string, amountIn: string } }>, purchases: Array<{ amount: string, blockNumber: string, blockTimestamp: string, buyer: string, id: string, payout: string, referrer: string, transactionHash: string }>, settle?: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string } | null, curated?: { blockNumber: string, blockTimestamp: string, curator: string, id: string, transactionHash: string } | null, baseToken: { address: string, decimals: string, symbol: string, name: string }, quoteToken: { address: string, decimals: string, name: string, symbol: string }, created: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, infoHash: string } }> };
...
export const useGetAuctionLotsQuery = <
    ...
    queryFn: fetcher<GetAuctionLotsQuery, GetAuctionLotsQueryVariables>(GetAuctionLotsDocument, variables),
    ...options
  }
    )};
...
export const useGetAuctionLotQuery = <
    ...
    queryFn: fetcher<GetAuctionLotQuery, GetAuctionLotQueryVariables>(GetAuctionLotDocument, variables),
    ...options
  }
    )};
