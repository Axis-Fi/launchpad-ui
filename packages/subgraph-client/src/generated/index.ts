...
export type AuctionLotFragmentFragment = { auctionRef: string, auctionType: string, capacity: string, capacityInitial: string, capacityInQuote: boolean, chain: string, conclusion: string, createdBlockNumber: string, createdBlockTimestamp: string, createdTransactionHash: string, curator: string, curatorApproved: boolean, derivativeRef: string, id: string, lastUpdatedBlockNumber: string, lastUpdatedBlockTimestamp: string, lastUpdatedTransactionHash: string, lotId: string, maxBidId: string, owner: string, purchased: string, sold: string, start: string, wrapDerivative: boolean, baseToken: { address: string, decimals: string, symbol: string, name: string, totalSupply: string }, quoteToken: { address: string, decimals: string, name: string, symbol: string }, created: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, infoHash: string }, bids: Array<{ id: string }>, bidsDecrypted: Array<{ id: string }>, refundedBids: Array<{ id: string }>, settle?: { id: string } | null };

export type GetAuctionLotsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAuctionLotsQuery = { auctionLots: Array<{ auctionRef: string, auctionType: string, capacity: string, capacityInitial: string, capacityInQuote: boolean, chain: string, conclusion: string, createdBlockNumber: string, createdBlockTimestamp: string, createdTransactionHash: string, curator: string, curatorApproved: boolean, derivativeRef: string, id: string, lastUpdatedBlockNumber: string, lastUpdatedBlockTimestamp: string, lastUpdatedTransactionHash: string, lotId: string, maxBidId: string, owner: string, purchased: string, sold: string, start: string, wrapDerivative: boolean, baseToken: { address: string, decimals: string, symbol: string, name: string, totalSupply: string }, quoteToken: { address: string, decimals: string, name: string, symbol: string }, created: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, infoHash: string }, bids: Array<{ id: string }>, bidsDecrypted: Array<{ id: string }>, refundedBids: Array<{ id: string }>, settle?: { id: string } | null }> };
...
export type GetAuctionLotQuery = { auctionLots: Array<{ auctionRef: string, auctionType: string, capacity: string, capacityInitial: string, capacityInQuote: boolean, chain: string, conclusion: string, createdBlockNumber: string, createdBlockTimestamp: string, createdTransactionHash: string, curator: string, curatorApproved: boolean, derivativeRef: string, id: string, lastUpdatedBlockNumber: string, lastUpdatedBlockTimestamp: string, lastUpdatedTransactionHash: string, lotId: string, maxBidId: string, owner: string, purchased: string, sold: string, start: string, wrapDerivative: boolean, cancelled?: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string } | null, bids: Array<{ amountIn: string, amountOut?: string | null, settledAmountOut?: string | null, submittedPrice?: string | null, rawAmountIn: string, rawAmountOut?: string | null, rawSubmittedPrice?: string | null, bidder: string, bidId: string, blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, status: string }>, refundedBids: Array<{ blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, bid: { bidId: string, bidder: string, amountIn: string } }>, bidsDecrypted: Array<{ amountIn: string, amountOut: string, blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, bid: { bidId: string, bidder: string, amountIn: string } }>, purchases: Array<{ amount: string, blockNumber: string, blockTimestamp: string, buyer: string, id: string, payout: string, referrer: string, transactionHash: string }>, settle?: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string } | null, curated?: { blockNumber: string, blockTimestamp: string, curator: string, id: string, transactionHash: string } | null, baseToken: { address: string, decimals: string, symbol: string, name: string, totalSupply: string }, quoteToken: { address: string, decimals: string, name: string, symbol: string }, created: { blockNumber: string, blockTimestamp: string, id: string, transactionHash: string, infoHash: string } }> };
...
export const useGetAuctionLotsQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<GetAuctionLotsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetAuctionLotsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetAuctionLotsQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['getAuctionLots'] : ['getAuctionLots', variables],
    queryFn: fetcher<GetAuctionLotsQuery, GetAuctionLotsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetAuctionLotsDocument, variables),
    ...options
  }
    )};
...
export const useGetAuctionLotQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<GetAuctionLotQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetAuctionLotQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetAuctionLotQuery, TError, TData>(
      {
    queryKey: ['getAuctionLot', variables],
    queryFn: fetcher<GetAuctionLotQuery, GetAuctionLotQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetAuctionLotDocument, variables),
    ...options
  }
    )};
